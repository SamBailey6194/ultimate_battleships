...
| 2 | User invited to log in or create user | Y = [Logging In](#if-user-goes-to-logging-in), N = [User Creation](#if-user-goes-to-user-creation) | ?? |
...
| Valid coordinate is from 0 to board size -1, and where they haven't shot yet |
